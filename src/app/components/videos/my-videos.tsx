  ...
  return (
    <div className="p-0 bg-white min-h-screen flex flex-col gap-6 w-90">
      {/* <label
        ...
        className="border-2 border-dashed border-primary p-6 flex flex-col items-center justify-center text-center text-primary cursor-pointer rounded-lg hover:border-primary-dark hover:text-primary-dark"
      >
        <input
          type="file"
          accept="video/*"
